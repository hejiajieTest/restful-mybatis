#!/bin/sh
#
# start restful-provider service
#
###EOF

prog=restfulprovider
export JAVA_HOME=/opt/jdk1.8.0_66
export DEPLOY_PATH=/opt/cloud/restful/restful-provider
export DEBUG_PORT=5166
...
-Dpaas.classpath=${DEPLOY_PATH}/lib cn.ffcs.tsp.main.StartUp $prog &
